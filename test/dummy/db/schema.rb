...
ActiveRecord::Schema[8.0].define(version: 2025_03_17_154716) do
  ...
  add_foreign_key "folio_files", "folio_users", column: "user_id"
  add_foreign_key "folio_private_attachments", "folio_users", column: "user_id"
  add_foreign_key "folio_session_attachments", "folio_users", column: "user_id"
