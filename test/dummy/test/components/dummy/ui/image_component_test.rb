...
class Dummy::Ui::ImageComponentTest < Folio::ComponentTest
  ...
  def test_placeholder_urls_skip_srcset
    ...
    placement_hash = {
      normal: "https://doader.com/100x100?image=456&size=100x100",
      retina: "https://doader.com/200x200?image=456&size=200x200",
      webp_normal: "https://doader.com/100x100?image=456&size=100x100.webp",
      webp_retina: "https://doader.com/200x200?image=456&size=200x200.webp"
    }

    render_inline(Dummy::Ui::ImageComponent.new(placement: placement_hash, size: "100x100"))
    ...
    assert_selector("img[src='https://doader.com/100x100?image=456&size=100x100']")
  end
