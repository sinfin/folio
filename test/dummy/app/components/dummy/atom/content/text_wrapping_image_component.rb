...
class Dummy::Atom::Content::TextWrappingImageComponent < ApplicationComponent
  THUMB_SIZES = {
    "origin" => "368x",
    "1x1" => "368x368#",
    "3x2" => "368x245#",
  ...
  def atom_class_name
    ary = []
    base = "d-atom-content-text-wrapping-image"
  ...
  def image_wrap_class
    base = "d-atom-content-text-wrapping-image__image-wrap"
