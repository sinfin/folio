...
class Folio::HasAtomsTest < ActiveSupport::TestCase
  ...
  test "atoms_in_molecules" do
    ...
    atom_1 = create_atom(Dummy::Atom::Contents::Text, position: 1, placement: page, content: "foo")
    page.reload
    ...
    atom_2 = create_atom(Dummy::Atom::Contents::Text, placement: page, position: 4, content: "a")
