...
### Fixed
- **Local direct uploads**: Return an S3-compatible `ETag` header from the local-file upload endpoint so Uppy recognizes successful uploads instead of reporting a misleading S3 CORS error.
