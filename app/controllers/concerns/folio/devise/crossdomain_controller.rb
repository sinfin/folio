...
module Folio::Devise::CrossdomainController
  ...
  private
    def handle_crossdomain_devise
      return if @devise_crossdomain_result
    ...
    def handle_crossdomain_devise_on_master_when_signed_in
      ...
      return unless session[SESSION_KEY][:source_site_slug]
      return unless session[SESSION_KEY][:crossdomain]

      source_site = Folio::Site.find_by_id(session[SESSION_KEY][:source_site_slug])
