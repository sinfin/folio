  ...
  addCsLocale () {
    ...
    window.Uppy.locales.cs_CZ = {
      ...
      strings: {
        ...
        back: 'Zpět',
        browse: 'výběrem',
        browseFiles: 'výběrem z disku',
        browseFolders: 'výběrem složky',
        cancel: 'Zrušit',
        ...
        dropHint: 'Nahrajte soubory přetažením do tohoto pole.',
        dropPasteBoth: 'Nahrajte soubory přetažením do tohoto pole, nebo %{browse}.',
        dropPasteFiles: 'Nahrajte soubory přetažením do tohoto pole, nebo %{browse}.',
        dropPasteFolders: 'Nahrajte soubory přetažením do tohoto pole, nebo %{browse}.',
        dropPasteImportBoth: 'Nahrajte soubory přetažením do tohoto pole, %{browse} nebo je importujte.',
        dropPasteImportFiles: 'Nahrajte soubory přetažením do tohoto pole, %{browse} nebo je importujte.',
        dropPasteImportFolders: 'Nahrajte soubory přetažením do tohoto pole, %{browse} nebo je importujte.',
