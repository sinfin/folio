    ...
    def file_placement_to_hash(fp)
      {
        file: {
          ...
          attribution_source: fp.file.attribution_source,
          attribution_source_url: fp.file.attribution_source_url,
          attribution_copyright: fp.file.attribution_copyright,
          attribution_licence: fp.file.attribution_licence,
