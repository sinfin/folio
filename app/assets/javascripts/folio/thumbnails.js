(function () {
  ...
  // Check if Stimulus is ready, if not defer execution
  if (window.Folio && window.Folio.Stimulus) {
    initThumbnails()
  } else {
    // Poll for Stimulus availability
    ...
    setTimeout(function () { clearInterval(checkStimulus) }, 10000)
  }
})()
