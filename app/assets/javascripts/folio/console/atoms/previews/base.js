...
(function () {
  var bindSortables, closeMobileControls, dontStoreScrollTop, handleArrowClick, handleEditClick, handleInsertClick, handleMobileclick, handleNewHtml, handleOverlayClick, handleRemoveClick, handleSplitableJoinTriggerClick, handleWillReplaceHtml, hideInsert, lazyloadAll, previousScrollTop, receiveMessage, restoreScrollTop, scrollTopCallbacksRun, selectLocale, sendMediaQueryRequest, sendResizeMessage, setMediaQuery, setScrollTopCallbacks, showInsertHint, storeScrollTop, unbindSortables, updateLabel, updatePerex, windowLoaded;
