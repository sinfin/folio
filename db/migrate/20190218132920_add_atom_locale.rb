...
class AddAtomLocale < ActiveRecord::Migration[5.2]
  def change
    ...
    Folio::Atom::Base.reset_column_information
    ...
    if Rails.application.config.folio_using_traco
      Folio::Atom::Base.find_each do |atom|
        ...
        (I18n.available_locales - [I18n.default_locale]).each do |locale|
          ...
          translation["title_#{I18n.default_locale}"] = atom["title_#{locale}"]
          translation["perex_#{I18n.default_locale}"] = atom["perex_#{locale}"]
          translation["content_#{I18n.default_locale}"] = atom["content_#{locale}"]
