...
Gem::Specification.new do |s|
  ...
  s.add_dependency "omniauth-facebook", "~> 9.0.0"
  s.add_dependency "omniauth-google-oauth2", "~> 1.0.1"
  s.add_dependency "omniauth-rails_csrf_protection"
  s.add_dependency "omniauth-twitter", "~> 1.4.0"
  s.add_dependency "omniauth", "~> 2.1.0"
  ...
  # for some reasons these two must be in Gemfile, to make them work
